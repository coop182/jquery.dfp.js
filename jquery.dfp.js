  ...
  (function(factory) {
    ...
    var // DFP account ID
      ...
      setOptions = function(options) {
        ...
        if (
          typeof options.setUrlTargeting === "undefined" ||
          options.setUrlTargeting
        ) {
          // Get URL Targeting
      ...
      createAds = function(dfpOptions, $adCollection) {
        ...
        googletag.cmd.push(function() {
          ...
          if (dfpOptions.setCookieOptions !== false) {
      ...
      displayAds = function(dfpOptions, $adCollection) {
        ...
        $adCollection.each(function() {
          ...
          if (
            dfpOptions.refreshExisting &&
            $adUnitData &&
            $adUnit.hasClass("display-block")
          ) {
            googletag.cmd.push(function() {
      ...
      getUrlTargeting = function(url) {
        ...
        var params = matchedQuery.replace(/\=/gi, ":").split("&");
      ...
      dfpLoader = function(options, $adCollection) {
        ...
        dfpIsLoaded =
          dfpIsLoaded ||
          $('script[src*="googletagservices.com/tag/js/gpt.js"]').length;
        if (dfpIsLoaded) {
